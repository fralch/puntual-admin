    ...
    return (
        <View style={[styles.container, { marginTop: 0 }]}>
            <View style={styles.cabecera}>
                <Text style={{ color: '#fff', fontSize: 20, fontWeight: 'bold' }}>Faltas</Text>
            </View>
                ...
                <View style={styles.footer}>
                    ...
                    >
...

                       {
                        ...
                        justifyContent: 'center', backgroundColor: '#A77F6A', padding: 10, 
                    ...
                    <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginTop: 20, backgroundColor: '#A77F6A', padding: 10, borderRadius: 5, marginBottom: 20 }}
